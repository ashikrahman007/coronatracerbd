<?php 
    ...
    $sql = INSERT INTO `covid19_sample_report` (`Sample_id`, `Email`, `Patient_name`, `Age`, `Sex`, `Blood_group`, `RESULT`, `COMMENT`) VALUES ('$Sample_id', '$Email', '$Patient_name', '$Age', '$Sex', '$Blood_group', '$RESULT','$COMMENT');
      ...
      elseif ($Pathologist_type=="COVID-19")
       {
          if ($result->num_rows > 0) 
          {
                  echo "<br><table align=center>
