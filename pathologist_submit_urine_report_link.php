<?php 
    ...
    $sql = "INSERT INTO `covid19_sample_report`(`covid_report_id`, `covid19_id`, `Email`, `Patient_name`, `Age`, `Sex`, `COMMENT`) VALUES ('$Sample_id','$Patient_name','$Email','$Age','$Sex', '$Blood_group','$covid19', '$RESULT','$COMMENT')";
      ...
      elseif ($Pathologist_type=="COVID19")
       {
          if ($result->num_rows > 0) 
          {
                  echo "<br><table align=center>
              ...
              while($row = $result->fetch_assoc())
               {
                  echo "<tr> 
                          ...
                          <td>".$row["Cost"]. "</td>  
                          <td>".$row["Sample_status"]. "</td>
                          <td>"."<a href='pathologist_submit_covid19_report_form.php?Sample_id=".$row["Sample_id"]."'>Submit</a>"."
                       </tr>";
              }
              echo "</table>";
          }
