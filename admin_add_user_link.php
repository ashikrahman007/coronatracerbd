...
<?php
    ...
    $Pathologist_type = $_POST['Pathologist_type'];

    $sql = "INSERT INTO user( User_name,Email,Password,Phone_number,User_type,Pathologist_type) VALUES ('$User_name','$Email','$Password', '$Phone_number','$User_type','$Pathologist_type')";

    if ($conn->query($sql) == TRUE) 
    {
       echo "<script> alert('Successfully Added. The user can login now');</script>";
    } 
    else 
    {
